...
# Install EGC git safety hooks globally via core.hooksPath.
# Usage:
...
# EGC_GLOBAL_HOOKS_DIR is canonical; ECC_GLOBAL_HOOKS_DIR is the legacy bridge.
DEST_DIR="${EGC_GLOBAL_HOOKS_DIR:-${ECC_GLOBAL_HOOKS_DIR:-$HOME/.codex/git-hooks}}"
...
log "Installed EGC global git hooks."
log "Disable per repo by creating .egc-hooks-disable in project root."
log "Temporary bypass: EGC_SKIP_PRECOMMIT=1 or EGC_SKIP_PREPUSH=1"
