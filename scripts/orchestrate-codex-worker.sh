...
cat > "$prompt_file" <<EOF
You are one worker in an EGC tmux/worktree swarm.
...
# Do not write handoff or status files yourself; the launcher manages those artifacts in ${EGC_ARTIFACTS_DIR:-artifacts}.
