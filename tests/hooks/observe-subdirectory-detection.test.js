...
function createTempDir() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'egc-observe-subdir-test-'));
}
...
function gitInit(dir) {
  ...
  const remoteResult = spawnSync(
    'git',
    ['remote', 'add', 'origin', 'https://github.com/example/egc-test.git'],
...
test('observe.sh resolves cwd to git root before setting GEMINI_PROJECT_DIR', () => {
