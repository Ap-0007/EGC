/**
 * Behavioral tests for egc_dashboard.py helper functions.
 */
...
const runtimeHelpersPath = path.join(repoRoot, 'scripts', 'lib', 'egc_dashboard_runtime.py');
...
spec = importlib.util.spec_from_file_location("egc_dashboard_runtime", r"""${runtimeHelpersPath}""")
