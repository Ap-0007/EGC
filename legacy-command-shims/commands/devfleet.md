---
description: Legacy slash-entry shim for the egc-devfleet skill. Prefer the skill directly.
---

# DevFleet (Legacy Shim)

Use this only if you still call `/devfleet`. The maintained workflow lives in `skills/egc-devfleet/SKILL.md`.

## Canonical Surface

- Prefer the `egc-devfleet` skill directly.
